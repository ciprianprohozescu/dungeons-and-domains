 ...
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.StateImpl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StateImpl extends MinimalEObjectImpl.Container implements State
{
  ...
  public void setDescription(String newDescription)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.STATE__DESCRIPTION, oldDescription, description));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.STATE__NAME:
        return getName();
      case MyDslPackage.STATE__DESCRIPTION:
